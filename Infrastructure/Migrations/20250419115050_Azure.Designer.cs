...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250419115050_Azure")]
    partial class Azure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Data.Entities.UserAddressEntity", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Infrastructure.Data.Entities.UserAddressEntity", b =>
                {
                    b.HasOne("Infrastructure.Data.Entities.UserEntity", "User")
                        .WithOne("Address")
                        .HasForeignKey("Infrastructure.Data.Entities.UserAddressEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
